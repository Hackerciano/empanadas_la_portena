...
"use strict";
(self.webpackChunkelementor = self.webpackChunkelementor || []).push([[835], {
    9556: (e, t, i) => {
        var n = i(6784);
    ...
    667: (e, t, i) => {
        ...
        class IconsManager {
            ...
            createSvgNode(e, t) {
                ...
                return Object.keys(i).map((e => s[e] = i[e])),
        ...
        e.exports = elementorModules.ViewModule.extend({
            ...
            setVideoContent(e) {
                ...
                if ("hosted" === e.videoType) {
                    ...
                    "yes" === e.autoplay ? (i.attr("allow", "autoplay"),
                    i.attr("src", n.getAutoplayURL(e.url))) : i.attr("src", e.url)
                }
            ...
            getRatioType(e) {
                let t = "";
                return t = 1 === e ? "square" : e < 1 ? "portrait" : "landscape",
                t
            },
            getShareLinks() {
            ...
            createShareLink(e, t) {
                ...
                const n = {};
                return "pinterest" === e ? n.image = encodeURIComponent(t) : n.url = encodeURIComponent(location.href.replace(/#.*/, "") + i),
                ShareLink.getNetworkLink(e, n)
            },
            getSlideshowHeader() {
                const {i18n: e} = elementorFrontend.config
                  , t = jQuery
                  , i = "yes" === elementorFrontend.getKitSettings("lightbox_enable_counter")
                  , n = "yes" === elementorFrontend.getKitSettings("lightbox_enable_fullscreen")
                  , s = "yes" === elementorFrontend.getKitSettings("lightbox_enable_zoom")
                ...
                if (i || n || s || l) {
                    ...
                    if (s) {
                        ...
                        n.push(d.$iconZoom),
                        this.isFontIconSvgExperiment && (d.$iconZoomOut = t(o.zoomOutBold.element).attr(s).addClass(a.hidden).on("click", this.toggleZoomMode),
                    ...
                    if (n) {
                        ...
                        d.$iconExpand = t(i).append(t("<span>"), t("<span>")).attr(l).on("click", this.toggleFullscreen),
                        n.push(d.$iconExpand),
                        this.isFontIconSvgExperiment && (d.$iconMinimize = t(o.frameMinimize.element).attr(s).addClass(a.hidden).on("click", this.toggleFullscreen),
            ...
            activateFullscreen() {
                const e = this.getSettings("classes");
                s.default.request(this.elements.$container.parents(".dialog-widget")[0]),
            ...
            activateZoom() {
                ...
                this.isFontIconSvgExperiment ? (t.$iconZoom.addClass(i.hidden).attr("aria-checked", "false"),
                t.$iconZoomOut.removeClass(i.hidden).attr("aria-checked", "true")) : t.$iconZoom.removeClass(i.slideshow.iconZoomIn).addClass(i.slideshow.iconZoomOut)
            },
            deactivateZoom() {
                const e = this.swiper
                  , t = this.elements
                ...
                this.isFontIconSvgExperiment ? (t.$iconZoom.removeClass(i.hidden).attr("aria-checked", "true"),
                t.$iconZoomOut.addClass(i.hidden).attr("aria-checked", "false")) : t.$iconZoom.removeClass(i.slideshow.iconZoomOut).addClass(i.slideshow.iconZoomIn)
            },
            getSlideshowFooter() {
                const e = jQuery
            ...
            setSlideshowContent(e) {
                ...
                if (e.slides.forEach((e => {
                    ...
                    if (e.video) {
                        ...
                        e.title && (o["data-title"] = e.title,
                        o.alt = e.title),
                        e.description && (o["data-description"] = e.description,
                        o.alt += " - " + e.description);
                        const l = i("<img>", o);
                        t.append([l, n]),
                        s.append(t)
                    }
                    e.hash && s.attr("data-e-action-hash", e.hash),
                    c.append(s)
                }
                )),
            ...
            activeKeyDown(e) {
                ...
                if (9 === e.which) {
                    ...
                    e.shiftKey ? n && (e.preventDefault(),
                    t.last().trigger("focus")) : !s && i || (e.preventDefault(),
            ...
            playSlideVideo() {
                ...
                s.append(o),
                e.append(s),
                -1 !== t.indexOf("vimeo.com") ? (a = "vimeo",
                r = elementorFrontend.utils.vimeo) : t.match(/^(?:https?:\/\/)?(?:www\.)?(?:m\.)?(?:youtu\.be\/|youtube\.com)/) && (a = "youtube",
